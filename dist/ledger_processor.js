...
import { addOrUpdateValidator, getValidator, distributeRewards, clearStakingLedger, slashValidator } from "./staking.js";
import { setContractCode } from "./ledger.js";
export { clearLedgerState as clearLedger };
export function processBlockTransactions(block) {
    ...
    for (const tx of block.data) {
        ...
        switch (tx.type) {
            ...
            case TxType.DEPLOY:
                ...
                setContractStorage(contractAddress, new Map());
...
export function rebuildLedgerFromChain(chain) {
    clearLedgerState();
    clearStakingLedger();
