...
export function registerStakingCommands(program) {
    program
        .command("stake")
    ...
    program
        ...
        if (fromValidatorValidation !== true) {
            console.error(chalk.red(`❌ ${fromValidatorValidation}`));
            return;
        }
    ...
    program
        ...
        if (addressValidation !== true) {
            console.error(chalk.red(`❌ ${addressValidation}`));
            return;
        }
